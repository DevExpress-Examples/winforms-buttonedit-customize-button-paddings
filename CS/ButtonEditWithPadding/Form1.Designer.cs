namespace ButtonEditWithPadding
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.carsDBDataSet = new ButtonEditWithPadding.CarsDBDataSet();
			this.carsBindingSource = new System.Windows.Forms.BindingSource();
			this.carsTableAdapter = new ButtonEditWithPadding.CarsDBDataSetTableAdapters.CarsTableAdapter();
			...
			// colTrademark
			// 
			this.colTrademark.ColumnEdit = this.repositoryItemPaddingButtonEdit1;
			...
			// colModel
			// 
			this.colModel.ColumnEdit = this.repositoryItemPaddingButtonEdit2;
